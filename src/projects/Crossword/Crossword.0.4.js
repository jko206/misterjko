/* 
 This thing cannot handle more than two words. Trying to call getPuzzles(['apple', 'carrot', 'banana'])
 * caused maximum call stack overflow.
 */
...
Object.prototype.clone = function(deepClone = true){
	...
	for(let i = 0; i < keys.length; i++){
		let key = keys[i];
		let elem = this[key];
		if(elem instanceof Function && (elem instanceof Object || elem instanceof Array)) elem = elem.clone(true);
		obj[key] = elem;
	}
	return obj;
}
